...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-10 mt-20 border-t-2 bg-background-elevated rounded-t-xl shadow-[0_-25px_35px_rgba(126,34,206,0.25)] border-t-purple-700 flex flex-col items-center gap-4">
